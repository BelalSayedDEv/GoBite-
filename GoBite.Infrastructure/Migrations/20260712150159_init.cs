...
namespace GoBite.Infrastructure.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    IsRemovable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    IngredientId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "CartItemRemovedIngredients",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItemRemovedIngredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartItemRemovedIngredients_CartItems_CartItemId",
                        column: x => x.CartItemId,
                        principalTable: "CartItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemRemovedIngredients_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemIngredients", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemAddons_CartItemId_ProductAddonId",
                table: "CartItemAddons",
                columns: new[] { "CartItemId", "ProductAddonId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemRemovedIngredients_CartItemId",
                table: "CartItemRemovedIngredients",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemRemovedIngredients_CartItemId_IngredientId",
                table: "CartItemRemovedIngredients",
                columns: new[] { "CartItemId", "IngredientId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CartItemRemovedIngredients_IngredientId",
                table: "CartItemRemovedIngredients",
                column: "IngredientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_DisplayOrder",
                table: "Ingredients",
                column: "DisplayOrder");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemAddons_OrderItemId_AddonId",
                table: "OrderItemAddons",
                columns: new[] { "OrderItemId", "AddonId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemIngredients_OrderItemId_IngredientId",
                table: "OrderItemIngredients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPromotions_ProductId_PromotionId",
                table: "ProductPromotions",
